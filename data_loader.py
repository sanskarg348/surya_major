...
def get_loader(transform,
    ...
    if mode == 'test' or mode == 'main':
        ...
        img_folder = 'images/'
        annotations_file = 'test_ann.json'
    ...
    dataset = CoCoDataset(transform=transform,
                          ...
                          img_folder=img_folder, surya=surya)
...
class CoCoDataset(data.Dataset):
    ...
    def __init__(self, transform, mode, batch_size, vocab_threshold, vocab_file, start_word, 
        end_word, unk_word, annotations_file, vocab_from_file, img_folder, surya):
    ...
    def __getitem__(self, index):
        ...
        # obtain image if in test mode
            ...
            if self.mode == 'test':
                ...
                orig_image = np.array(self.surya)
                PIL_image = self.surya.convert('RGB')
